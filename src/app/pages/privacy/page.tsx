        ...
        <div className="privacy">
            ...
            <div className="privacy-block">
                <div className="privacy-text">
                    ...
                    Волгоградский камнеобрабатывающий завод (далее — Оператор).
                </div>
                <div className="privacy-text">
                ...
                <div className="privacy-text">
                    ...
                    Пользователю веб-сайта https://vkz134.ru.
                </div>
                <div className="privacy-text">
                ...
                <div className="privacy-text">
                    2.10. Пользователь — любой посетитель веб-сайта https://vkz134.ru.
                </div>
                <div className="privacy-text">
                ...
                <div className="privacy-text">3.1. Оператор имеет право:</div>
                <div className="privacy-text">
                ...
                <div className="privacy-text">3.2. Оператор обязан:</div>
                <div className="privacy-text">
                ...
                <div className="privacy-text">
                    ...
                    <ul className="privacy-list">
                        ...
                        <li className="privacy-item">
                            ...
                            обезличивание персональных данных; Отправка
                ...
                <div className="privacy-text">
                    ...
                    Оператора vkz134@yandex.ru с пометкой «Актуализация
                    персональных данных».
                </div>
                <div className="privacy-text">
                ...
                <div className="privacy-text">
                    ...
                    адрес Оператора vkz134@yandex.ru с пометкой «Отзыв согласия
                ...
                <div className="privacy-text">
                    11. Конфиденциальность персональных данных Оператор и иные
                ...
                <div className="privacy-text">12. Заключительные положения</div>
                <div className="privacy-text">
                ...
                <div className="privacy-text">
                    ...
                    расположена в сети Интернет по адресу https://vkz134.ru
                </div>
                <div className="privacy-text">
                    <div className="privacy-item">
                        <div className="privacy-item-text">12.4. Реквизиты</div>
                        <div className="privacy-item-text">
                            ООО «Волгоградский камнеобрабатывающий завод»
                        </div>
                        <div className="privacy-item-text">ИНН 3443153330</div>
                        <div className="privacy-item-text">КПП 344301001</div>
                        <div className="privacy-item-text">
                            ОГРН 1243400010149
                        </div>
                        <div className="privacy-item-text">
                            Юридический адрес: 400048, Волгоградская область,
                            г.о. Город-Герой Волгоград, г. Волгоград, ш.
                            Авиаторов, д. 16, помещ. 12
                        </div>
                        <div className="privacy-item-text">
                            Почтовый адрес: 400048, г. Волгоград, ш. Авиаторов,
                            д. 16, помещ. 12
                        </div>
                        <div className="privacy-item-text">БИК: 041806647</div>
                        <div className="privacy-item-text">
                            Р/с: 40702810911000042925
                        </div>
                        <div className="privacy-item-text">
